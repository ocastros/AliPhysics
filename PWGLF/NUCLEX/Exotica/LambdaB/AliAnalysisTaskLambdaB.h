#ifndef AliAnalysisTaskLambdaB_H
#define AliAnalysisTaskLambdaB_H
...
public:
  ...
  static AliAnalysisTaskLambdaB *AddTask(bool isMC = false, TString suffix = "");
...
private:
  ...
  TH2D *fHistNSigmaHelium = nullptr;    //! # sigma TPC for the deuteron
  TH2D *fHistNSigmaAP1 = nullptr;      //! # sigma TPC proton for the positive prong
  TH2D *fHistNSigmaAP2 = nullptr;     //! # sigma TPC pion for the negative prong
  ...
  ClassDef(AliAnalysisTaskLambdaB, 1);
};
